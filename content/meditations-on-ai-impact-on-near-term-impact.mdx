...
We’ll develop technology to verify that an image/video was actually taken on a real life camera which detected light rays that hit a sensor. Assume AI doesn’t own phones, because as I mentioned before, it’ll take a while before AI is embodied
