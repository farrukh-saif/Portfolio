...
2. Syntax
3. Tradeoff between better code vs more time spent on it - there's always a cleaner, better, faster way to do something.
4. Real life isn't as clean as the courses — think invalid cache, failing cloud functions, bad actors you now have to account for.
